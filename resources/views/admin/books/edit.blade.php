    ...
    <div class="col-lg-8 col-md-10 mx-auto">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-warning text-dark">
                <h5 class="mb-0"><i class="fas fa-edit"></i> Form Edit Buku</h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="mt-2">
                                    ...
                                    <img src="{{ $book->image }}" alt="Current cover" class="img-thumbnail"
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          placeholder="Masukkan deskripsi atau sinopsis buku (opsional)">{{ old('description', $book->description) }}</textarea>
                                @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
